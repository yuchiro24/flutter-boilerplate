...
abstract class $RoomCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String? title, int digits});
}
...
class _$_Room extends _Room {
  _$_Room({required this.id, this.title, required this.digits}) : super._();
  ...
  @override
  String toString() {
    return 'Room(id: $id, title: $title, digits: $digits)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, digits);
...
abstract class _Room extends Room {
  factory _Room(
      ...
      final String? title,
      required final int digits}) = _$_Room;
  _Room._() : super._();
