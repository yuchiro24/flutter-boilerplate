...
abstract class $MemberCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, bool isReady});
}
...
class _$_Member extends _Member {
  _$_Member({this.id = '', this.name = '', this.isReady = false}) : super._();
  ...
  @override
  String toString() {
    return 'Member(id: $id, name: $name, isReady: $isReady)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, isReady);
...
abstract class _Member extends Member {
  factory _Member({final String id, final String name, final bool isReady}) =
      _$_Member;
  _Member._() : super._();
