...
class _$_HomePageState implements _HomePageState {
  const _$_HomePageState({final List<Card> cards = const <Card>[]})
      : _cards = cards;
  ...
  @override
  String toString() {
    return 'HomePageState(cards: $cards)';
  }
...
abstract class _HomePageState implements HomePageState {
  const factory _HomePageState({final List<Card> cards}) = _$_HomePageState;
